...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Employeer Register') }}</div>

                <div class="card-body">
                        <form method="POST" action='{{ url("register/employeer") }}' aria-label="{{ __('Register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="bio" class="form-control" id="" cols="20" rows="5"></textarea>
                            </div>
                        </div>
