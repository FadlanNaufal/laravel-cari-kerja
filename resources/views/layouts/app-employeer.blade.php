...
<head>
  ...
  <title>Cari Kerja &mdash; Employeer </title>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" style="width : 40px ; height : 40px" src="upload/employeer/{{ Auth::guard('employeer')->user()->profile_picture }}" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Hi, {{Auth::guard('employeer')->user()->name}}</div></a>
